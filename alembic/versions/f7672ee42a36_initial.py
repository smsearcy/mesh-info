...
def upgrade():
    ...
    op.create_table('collector_stat',
    sa.Column('started_at', pymeshmap.models.meta.PDateTime(timezone=True), nullable=False),
    sa.Column('finished_at', pymeshmap.models.meta.PDateTime(timezone=True), nullable=False),
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', name='nodestatus', native_enum=False), nullable=False),
    ...
    sa.Column('last_seen', pymeshmap.models.meta.PDateTime(timezone=True), nullable=False),
    ...
    sa.Column('created_at', pymeshmap.models.meta.PDateTime(timezone=True), nullable=False),
    sa.Column('last_updated_at', pymeshmap.models.meta.PDateTime(timezone=True), nullable=False),
    ...
    sa.Column('type', sa.Enum('DTD', 'TUN', 'RF', 'UNKNOWN', name='linktype'), nullable=False),
    sa.Column('status', sa.Enum('CURRENT', 'RECENT', 'INACTIVE', name='linkstatus', native_enum=False), nullable=False),
    sa.Column('last_seen', pymeshmap.models.meta.PDateTime(timezone=True), nullable=False),
    ...
    sa.Column('created_at', pymeshmap.models.meta.PDateTime(timezone=True), nullable=False),
    sa.Column('last_updated_at', pymeshmap.models.meta.PDateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['destination_id'], ['node.node_id'], name=op.f('fk_link_destination_id_node')),
    sa.ForeignKeyConstraint(['source_id'], ['node.node_id'], name=op.f('fk_link_source_id_node')),
    sa.PrimaryKeyConstraint('source_id', 'destination_id', 'type', name=op.f('pk_link'))
    )
